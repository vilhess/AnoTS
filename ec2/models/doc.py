...
class DOC(nn.Module):
    def __init__(self, num_cont_var=4, embedding_dim=2, hidden_size=128, seq_len=32, latent_dim=32, num_layers=2, bidirectional=True):
        ...
        self.lstm = nn.LSTM(input_size=embedding_dim + num_cont_var, hidden_size=hidden_size, num_layers=num_layers, batch_first=True, bidirectional=bidirectional, bias=False)
